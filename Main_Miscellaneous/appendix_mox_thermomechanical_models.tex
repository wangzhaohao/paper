...
\begin{equation}
	...
	\end{aligned}
	\label{eq:appendix_matpro_scattering_parameters}
\end{equation}
\label{eq:appendix_matpro_A}
...
\begin{equation}
	...
	\end{aligned}
	\label{eq:appendix_bison_thermal_conductivity_general}
\end{equation}
...
\begin{equation}
	\begin{aligned}
		T_n&=\frac{T}{1000}\\
				...
				C(x)&=0.715x+0.286
	\end{aligned}
	\label{eq:appendix_duriez_parameters}
\end{equation}
\label{eq:appendix_duriez_reduced_temperature}
\label{eq:appendix_duriez_A}
\label{eq:appendix_duriez_C}
...
Fink模型给出的$95\%$理论密度未辐照$\mathrm{UO}_2$热导率及其全致密换算关系为
\begin{equation}
	\begin{aligned}
		k_{95}
		&=
...
其中，$T_n=T/1000$。Fink模型本身针对$\mathrm{UO}_2$，在MOX计算中通常作为Amaya等组成修正模型的基准。
...
\begin{equation}
	...
	\end{aligned}
	\label{eq:appendix_halden_terms}
\end{equation}
\label{eq:appendix_halden_q0}
\label{eq:appendix_halden_q1}
\label{eq:appendix_halden_q2}
\label{eq:appendix_halden_q3}
\label{eq:appendix_halden_q4}
\label{eq:appendix_halden_q5}
...
\begin{equation}
	\begin{aligned}
		F_1&=
				...
				F_4&=1-\alpha P
	\end{aligned}
	\label{eq:appendix_fast_mox_correction_factors}
\end{equation}
...
\begin{equation}
	\begin{aligned}
		Q_1&=17884.8
				...
				+111543.5
	\end{aligned}
	\label{eq:appendix_uo2_activation_energies}
\end{equation}
...
\begin{equation}
	...
	\end{aligned}
	\label{eq:appendix_fast_mox_creep_parameters}
\end{equation}
...
\begin{equation}
	...
	\end{aligned}
	\label{eq:appendix_densification_resintering}
\end{equation}
...
\begin{equation}
	\begin{aligned}
		\left(\frac{\Delta L}{L}\right)_m
				...
				&&T_f\geq1000\ \mathrm{K}
	\end{aligned}
	\label{eq:appendix_densification_sintering_temperature}
\end{equation}
