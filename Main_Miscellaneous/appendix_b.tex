...
\end{aligned}
\label{eq:app_b_rand_markin_migration_control}
\end{equation}
...
\end{aligned}
\label{eq:app_b_rand_markin_vapor_pressures}
\end{equation}
...
\end{aligned}
\label{eq:app_b_rand_markin_gibbs_relations}
\end{equation}
...
\label{eq:app_b_oxygen_pressure_stoichiometry}
\end{equation}
...
\end{aligned}
\label{eq:app_b_oxygen_pressure_auxiliary_terms}
\end{equation}
...
\end{aligned}
\label{eq:app_b_plutonium_concentration_definition}
\end{equation}
...
\label{eq:app_b_total_vapor_pressure}
\end{equation}
...
\label{eq:app_b_lackey_migration_velocity}
\end{equation}
...
\end{aligned}
\label{eq:app_b_sens_vapor_pressure}
\end{equation}
...
\label{eq:app_b_nichols1967_migration_velocity}
\end{equation}
...
\label{eq:app_b_nichols1972_migration_velocity}
\end{equation}

孔隙内部的温度梯度$\nabla T$与宏观温度梯度$\nabla T_\infty$是不同的，取决于孔隙形状和气体的热导率。
\begin{equation}
\nabla T = \frac{\nabla T_\infty}{1 + C_0 (K_g/K_m - 1)}
\label{eq:app_b_nichols1972_temperature_gradient}
\end{equation}
二元气体扩散系数$D_g$显式计算：
\begin{equation}
D_g = \frac{3}{8 n \sigma^2} \sqrt{\frac{R T (M_1 + M_2)}{2\pi M_1 M_2}}
\label{eq:app_b_nichols1972_binary_diffusivity}
\end{equation}

气体分子数密度$n$由理想气体状态方程计算：
\begin{equation}
n = \frac{P}{k T}
\label{eq:app_b_nichols1972_number_density}
\end{equation}
...
\label{eq:app_b_clement_finnis_migration_velocity}
\end{equation}
