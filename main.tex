% !TeX document-id = {d8d70279-66e7-430f-9a84-8edb8c530a50}
% !TEX program = latexmk
...
\usepackage{xltabular}  % 核心：用于跨页表格
\usepackage{ragged2e}   % 核心：用于 \RaggedRight 左对齐
\usepackage{booktabs}   % 用于三线表 (\toprule, \midrule)
\usepackage{array}      % 基础表格增强
\usepackage{placeins}
...
\title{面向数字孪生的氧化物燃料元件高保真模拟与快速预测方法研究}{High-Fidelity Simulation and Rapid Prediction Methods for Oxide Fuel Elements toward Digital Twins}
...
% 
\subject{核科学与核技术}{Nuclear Science and Nuclear Technology}
...
\thesisappendix{Main_Miscellaneous/appendix_a,
	...
	Main_Miscellaneous/appendix_mox_thermomechanical_models,
	Main_Miscellaneous/appendix_cladding_incore_models,
	Main_Miscellaneous/appendix_gap_heat_transfer_models}
